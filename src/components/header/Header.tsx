  ...
  return (
    <header className="flex flex-col items-center justify-center pt-15 pb-5 gap-10 bg-emerald-50/40">
      <div className="flex items-center justify-center flex-col gap-5 px-5">
        <h1 className="text-(length:--main-text) font-extrabold text-2xl">
          Calculadora TDEE
        </h1>
        <h2 className="text-(length:--secondary-text) max-w-150 text-center text-gray-400">
      ...
      <span className="material-symbols-outlined animate-bounce text-emerald-400">
        keyboard_arrow_down
      </span>
    </header>
  );
